...
//postcondition: going to have privates, one stack that checks for the board, three int, one char, one bool, then in public we got default constructor, setters and getters, and member functions 
